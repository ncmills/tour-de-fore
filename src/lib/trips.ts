...
export const trips: Trip[] = [
  {
    ...
    state: "Michigan",
    stateAbbr: "MI",
    tagline: "Grand Traverse Bay, 2027 — details to be determined.",
    dates: "Summer 2027 · TBD",
    upcoming: true,
    // Placeholder scenic for the trip card while the itinerary is being built —
    // swap for a real trip photo after the trip (mirrors how 2026 launched with a
    // stock hero). The live page renders the glowing year, not this image.
    heroImage: "/photos/2027/traverse-city.jpg",
    // Everything below is intentionally empty until the trip is planned. The live
    // template guards every section on content length, so an empty shell renders
    // cleanly as the year hero + map + summary. Fill these in as plans firm up.
    courses: [],
    restaurants: [],
    schedule: [],
    photoSections: [],
