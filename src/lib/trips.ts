    ...
    schedule: [
      {
        day: "Tuesday",
        date: "July 6",
        subtitle: "Arrival — bus waves from Pellston and Traverse City, 4:00 PM check-in at The Reserve",
        items: [
          {
            time: "—",
          ...
          {
            time: "7:00 PM",
            activity: "House Dinner & Opening Ceremonies",
            detail: "Bed draft · skirts · State of the Trip",
            type: "dining",
            location: "At the house",
            description: "Bed assignments per the pre-trip athletic-feat draft — video submissions were due June 1, the commissioner judged them alone, and the rulings are final. Rookie skirt distribution follows. The sophomores close it out with the State of the Trip address, which nobody has ever asked for and which will be delivered anyway.",
            facts: ["Bed draft order per athletic-feat competition", "Rookie skirt distribution", "Sophomore State of the Trip address"],
          },
        ],
      },
      {
        day: "Wednesday",
        date: "July 7",
        subtitle: "Rest day — zipline out the front door, ATVs in the afternoon, home by 4 for the lake",
        items: [
          {
            time: "10:00 AM",
      ...
      },
      {
        day: "Thursday",
        date: "July 8",
        subtitle: "Day 1 — the showstopper: Bay Harbor on the bluffs, then Crooked Tree above the bay — 🚌 35 min out, 5 min between",
        items: [
          {
            time: "8:00 AM",
      ...
      },
      {
        day: "Sunday",
        date: "July 11",
        subtitle: "Lake day — nothing scheduled, and that is the schedule",
        items: [
          {
            time: "10:00 AM",
            activity: "Rookie Christenings",
            detail: "Breakfast · names conferred",
            type: "dining",
            location: "At the house",
            description: "The rookies get their permanent trip names at breakfast. There is no appeals process, and the name outlives the trip.",
            facts: ["Permanent names conferred", "No appeals"],
          },
          {
            time: "12:00 PM",
            activity: "Deer Lake",
            ...
            description: "The beach at Deer Lake runs 10 AM to 8 PM with a sandy bottom that stays shallow more than a hundred feet out, paddleboards, beach beverages, and the Beach House for lunch without leaving the water. Optional pontoon on Walloon or Lake Charlevoix for anyone with ambition left.",
            facts: ["Beach open 10 AM – 8 PM", "Paddleboards · beach bar · Beach House", "Optional pontoon: Walloon / Lake Charlevoix"],
          },
        ],
      },
      {
        day: "Monday",
        date: "July 12",
        subtitle: "Depart — 117 holes, 7 courses, 6 nights in the books · est. $2,300–2,600 per man, ex-airfare, bars and lunches",
        items: [
          { time: "10:00 AM", activity: "Checkout & Bus Waves Out", detail: "✈️ Fly out", type: "activity" as const, location: "Boyne Falls, MI" },
        ],
      },
    ],
    photoSections: [],
