...
export const trips: Trip[] = [
  {
    year: 2027,
    slug: "2027",
    // Display location = the recognizable gateway airport (TVC, 60 min out). The
    // house and every course are in the Boyne Falls / Petoskey / Harbor Springs
    // corridor — see lodgingAddress and the per-course `location` fields.
    // (Same pattern as 2026: card reads "Kohler", lodge is in Cleveland, WI.)
    location: "Traverse City",
    state: "Michigan",
    stateAbbr: "MI",
    tagline: "North of everything, and all 16 devils are here.",
    dates: "July 6 – 12, 2027",
    upcoming: true,
    lodgingName: "The Reserve at Boyne Mountain",
    ...
    courses: [
      {
        ...
        phone: "(844) 763-0347",
        amenities: "27-hole facility, on-site dining, Little Traverse Bay views",
      },
      {
        ...
        amenities: "Full driving range, putting green, short-game area (range balls included)",
      },
      {
        ...
        notes: "2019 National Golf Course of the Year",
      },
      {
        ...
        holes: 18,
        location: "600 Highlands Drive, Harbor Springs, MI 49740",
        notes: "AJGA Championship course · walk out of The Heather onto the first tee",
      },
      {
        ...
        amenities: "Driving range, three putting greens, three short-game areas",
      },
      {
        ...
        holes: 18,
        location: "Boyne Falls, MI",
        notes: "Holes modeled on Ross, MacKenzie, Jones, Fazio and Dye",
      },
      {
        ...
        designer: "Rick Smith",
        notes: "9 par-3s · 145-foot drop · Trevino's $1,090,000 ace on #7, 2001",
      },
    ],
    restaurants: [
      {
    ...
    schedule: [
      {
        day: "Tuesday",
        date: "July 6",
        subtitle: "Light hang. Whoever can get here early — fly in, stock the house, settle in",
        items: [
          {
            time: "—",
            activity: "Fly into Pellston or Traverse City",
            detail: "✈️ PLN (45 min) · TVC (60 min)",
          ...
          },
          {
            ...
            type: "activity",
            location: "Petoskey, MI",
            description: "One stop in Petoskey on the way in, and it is the only stop. Six nights, sixteen men, one basement bar. Buy accordingly.",
          },
          {
            time: "4:00 PM",
            activity: "Check In — The Reserve at Boyne Mountain",
          ...
          {
            time: "7:00 PM",
            activity: "House Dinner",
            detail: "Whoever's here",
            type: "dining",
            location: "At the house",
            description: "Easy first night. Beds go by the pre-trip athletic-feat draft — submissions due June 1, commissioner judges, rulings final.",
            facts: ["Bed draft", "Skirts handed out"],
          },
        ],
      },
      {
        day: "Wednesday",
        date: "July 7",
        subtitle: "Light hang, optional — zipline out the front door, ATVs in the afternoon, home by 4 for the lake",
        items: [
          {
            time: "10:00 AM",
            arriveTime: "arrive 9:30 AM",
            activity: "Boyne Mountain Zipline Adventure",
          ...
          {
            time: "12:15 PM",
            activity: "Bus to the ATV Outfitter",
            detail: "Indian River / Wolverine corridor",
            type: "activity",
            location: "Indian River, MI",
            description: "Roughly 30 to 35 minutes east to the state ORV trail network. Quick tavern stop or packed lunch on arrival — this is the one meal of the week nobody is precious about.",
          },
          {
            time: "1:45 PM",
            activity: "ATV Ride",
          ...
          {
            time: "4:15 PM",
            activity: "Hot Tub · Sauna · Deer Lake",
            detail: "Nothing scheduled",
            type: "activity",
            location: "At the house",
            description: "Home by mid-afternoon on purpose. The hot tub, the sauna, and the water are all out the back, and Thursday is a 36-hole day. Use the time.",
          },
          {
            time: "7:00 PM",
            activity: "Dinner at the House",
            detail: "Casual",
            type: "dining",
            location: "At the house",
            description: "Nothing scheduled around it. Stiggs out of Boyne City is the lead — slow-smoked BBQ by the pound with sides, picked up or delivered, fifteen minutes away.",
            facts: ["Stiggs Brewery & Kitchen, Boyne City — (231) 497-6100", "Mighty Fine Pizza, Petoskey — (231) 347-3255", "Boyne Mountain resort dining — walkable fallback"],
          },
        ],
      },
      {
        day: "Thursday",
        date: "July 8",
        subtitle: "Day 1, full group — the showstopper: Bay Harbor on the bluffs, then Crooked Tree above the bay. Rookies in skirts. Welcome dinner tonight — 🚌 35 min out, 5 min between",
        items: [
          {
            time: "8:00 AM",
            activity: "Bay Harbor Golf Club — Links/Quarry",
            detail: "18 holes",
            type: "golf",
            location: "Bay Harbor, MI",
            architect: "Arthur Hills",
            description: "Arthur Hills built this on four miles of Lake Michigan shoreline and a dead shale quarry, and Bay Harbor sells it as \"the Pebble Beach of the Midwest\" — a line that survives contact with the golf course, which is more than most such lines manage. The Links nine plays 3,449 yards across towering bluffs and windblown dunes; the third is the fan favorite, a split-level fairway over the water that offers two honest routes and rewards picking one. The Quarry nine drops into the pit — 3,396 yards past 40-foot gorges, stone cliffs, ponds, and a waterfall. First round of the week, and deliberately the best one to open on.",
            bus: "~35 min from the house",
            facts: ["Rookies in skirts", "27-hole facility", "Arthur Hills design", "Lake Michigan bluffs + quarry walls"],
          },
          {
            time: "1:45 PM",
            activity: "Crooked Tree Golf Club",
            detail: "18 holes",
            type: "golf",
            location: "Petoskey, MI",
            description: "Five minutes up the hill and an entirely different round. Crooked Tree sits on the bluffs high above Little Traverse Bay, carved through centuries-old hardwood — 6,640 yards, par 71, short on the card and long in practice. The greens undulate enough that the scorecard gets decided with a putter. The 17th looks back over Lake Michigan into the sunsets Petoskey advertises, and the afternoon tee time means we get them without having to wait around for them.",
            bus: "~5 min from Bay Harbor",
            facts: ["Bluffs over Little Traverse Bay", "Old-growth hardwood routing", "Range balls included"],
          },
          {
            time: "7:30 PM",
            activity: "Welcome Dinner",
            detail: "Sophomore speeches · shotguns",
            type: "dining",
            location: "At the house",
            description: "Opening night proper — everyone is finally in the building. Mighty Fine out of Petoskey is the honest call after 36 holes; Stiggs BBQ if anyone wants more.",
            facts: ["Sophomore speeches + shotguns", "Cash fines settled", "Mighty Fine Pizza, Petoskey — (231) 347-3255", "Stiggs BBQ carryout"],
          },
        ],
      },
      {
        day: "Friday",
        date: "July 9",
        subtitle: "Day 2 — 36 at The Highlands, zero transfer between rounds — 🚌 40 min out, hibachi at the house",
        items: [
          {
            time: "8:00 AM",
            activity: "The Heather — The Highlands",
            detail: "18 holes",
            type: "golf",
            location: "Harbor Springs, MI",
            architect: "Robert Trent Jones Sr.",
            description: "The course everything else up here descends from. Jones Sr. opened The Heather in 1966 as the first BOYNE course and it is still the flagship — 7,143 yards, par 72 from the Browns, 2019 National Golf Course of the Year, 2018 Michigan Golf Course of the Year, with Michigan Amateurs and the Michigan State Pro-Am on the wall. Classic Jones: the trouble is in front of you, every miss is your own signature, and the 18th makes you carry water to sign for anything.",
            bus: "~40 min from the house",
            facts: ["RTJ Sr. flagship, opened 1966", "7,143 yards · par 72", "2019 National Golf Course of the Year"],
          },
          {
            time: "1:30 PM",
            activity: "The Moor — The Highlands",
            detail: "18 holes",
            type: "golf",
            location: "Harbor Springs, MI",
            description: "Same property, no transfer, different disposition. The Moor is the members' pick — 6,850 yards, par 72, threaded through marsh and water with doglegs stacked across the front nine that reward a right-handed power fade and quietly ruin everybody else. New tour bunker sand throughout. The 18th is a full checklist: water twice, wetlands, trees, bunkers, and a couple of doglegs. This is the half of the day where the week starts telling the truth about who brought a short game.",
            bus: "Walk from The Heather — zero transfer",
            facts: ["Members' favorite", "AJGA Championship course", "6,850 yards · par 72"],
          },
          {
            time: "7:30 PM",
            activity: "Hibachi Night",
            detail: "Chef at the house · rookie christenings",
            type: "dining",
            location: "At the house",
            description: "A teppanyaki chef comes to us — knives, onion volcano, the whole performance, in a rented kitchen in Boyne Falls. Hibachi Connect is the pick: certified chef, two proteins a man, fried rice, vegetables, every sauce, full setup and cleanup, 90 to 120 minutes of show.",
            cost: "$60/adult · $600 event minimum",
            facts: ["Hibachi Connect — (201) 565-3878", "Covers Boyne City / Harbor Springs / Emmet + Charlevoix", "10-guest minimum · one chef station up to 25", "Book 3–4 weeks out — July fills first", "Rookie christenings — nicknames + shots", "Vet testimony"],
          },
        ],
      },
      {
        day: "Saturday",
        date: "July 10",
        subtitle: "Day 3 — 36 out the front door, then Threetops at golden hour — 🚌 no bus till 6:45 PM",
        items: [
          {
            time: "8:30 AM",
            activity: "The Alpine — Boyne Mountain",
            detail: "18 holes",
            type: "golf",
            location: "Boyne Falls, MI",
            description: "Out the front door — no bus, no drive, no excuse for a late tee time. The Alpine trends down the mountain off elevated boxes with panoramic views toward Deer Lake and the Jordan Valley, and the 4th tee costs people strokes purely because the view is expansive enough that nobody remembers to pick a target. Par 72 from 5,053 to 7,045 yards. It's the forgiving one of the pair: open off the tee, greens that build confidence rather than take it. Hosts Michigan's Tournament of Champions annually.",
            bus: "Walk from the house",
            facts: ["Front-door course", "Elevated tees over the Jordan Valley", "Golf Digest Editors' Choice"],
          },
          {
            time: "2:00 PM",
            activity: "The Monument — Boyne Mountain",
            detail: "18 holes",
            type: "golf",
            location: "Boyne Falls, MI",
            description: "The Alpine's meaner sibling, also out the front door. The Monument is a tribute course — holes drawn from Ross, MacKenzie, Jones, Fazio and Dye, each dedicated to somebody who mattered — which reads like a gimmick until you're on a demanding fairway staring at an undulating green and realize it wants a complete game, not a favorite shot. Par 72 across six tees from 4,879 to 6,964 yards, slope up to 141. The 16th honors Everett Kircher and features a fairway bunker mound whose construction material BOYNE pointedly declines to name.",
            bus: "Walk from the house",
            facts: ["Holes modeled on Ross, MacKenzie, Jones, Fazio, Dye", "Slope up to 141", "USA Today 10Best"],
          },
          {
            time: "7:30 PM",
            activity: "Threetops at Treetops",
            detail: "9 holes (par-3) · golden hour",
            type: "golf",
            location: "Gaylord, MI",
            architect: "Rick Smith",
            description: "The finale. Rick Smith opened Threetops in 1992 — nine par-3s from 78 to 219 yards, one dropping 145 feet from tee to green and another 90, enough hang time to change your mind about the club twice on the way down. It hosted the ESPN Par-3 Shootout for eight years, and in 2001 Lee Trevino stood on the 7th, \"High Five,\" flew the green, spun it back into the cup and walked off with $1,090,000 for one swing. Links Magazine files it under the baddest par 3s in America. Sunset is around 9:20. The trophy gets decided on Trevino's hole in the last good light of the week.",
            bus: "6:45 PM pickup → ~35 min to Gaylord",
            facts: ["9 par-3s · 78–219 yards", "145-foot drop tee to green", "Trevino's $1,090,000 ace on #7, 2001", "Sunset ~9:20 PM"],
          },
          {
            time: "10:30 PM",
            activity: "Ordered-In Feast #3 — Belt Night",
            detail: "Belt · superlatives",
            type: "dining",
            location: "At the house",
            description: "Last night with anything at stake — we roll in from Gaylord near midnight, so order before we leave for Threetops and eat it cold if it comes to that.",
            facts: ["Belt + trophy", "Superlatives", "Senior worst-first-date testimony", "Order before the Threetops bus leaves", "Stiggs BBQ — reheats best"],
          },
        ],
      },
      {
        day: "Sunday",
        date: "July 11",
        subtitle: "Hungover. Nothing scheduled, nothing required — leave when you want or stay and fly out tonight",
        items: [
          {
            time: "—",
            activity: "Wake Up Whenever",
            detail: "Leave today or don't",
            type: "activity",
            location: "At the house",
            description: "No alarm, no tee time, no bus. Fly out this morning if you have to be somewhere, or hang around and take a night flight. Nobody is organizing anything and that is the entire point.",
          },
          {
            time: "—",
            activity: "Deer Lake, If Anyone Moves",
            detail: "Out the back door",
            type: "activity",
            location: "Deer Lake · Boyne Falls, MI",
            description: "The beach runs 10 AM to 8 PM with a sandy bottom that stays shallow more than a hundred feet out, paddleboards, beach beverages, and the Beach House for lunch without leaving the water. Entirely optional, like everything else today.",
            facts: ["Beach open 10 AM – 8 PM", "Paddleboards · beach bar · Beach House"],
          },
        ],
      },
      {
        day: "Monday",
        date: "July 12",
        subtitle: "Nothing scheduled — 117 holes, 7 courses, 6 nights in the books · est. $2,300–2,600 per man, ex-airfare, bars and lunches",
        items: [
          {
            time: "—",
            activity: "Out Whenever",
            detail: "✈️ Fly out",
            type: "activity" as const,
            location: "Boyne Falls, MI",
            description: "We hold the house through Monday for exactly one reason: so nobody has to sprint out the door Sunday morning with a bag half-packed. There is nothing on the schedule. Sleep in, clean up, go home.",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    heroImage: "/photos/2026/IMG_4399.jpeg",
    courses: [
      {
    ...
    gallery: [
      "/photos/2026/IMG_4399.jpeg",
      "/photos/2026/IMG_8919.jpeg",
      "/photos/2026/IMG_2531.jpeg",
      "/photos/2026/IMG_4394.jpeg",
      "/photos/2026/IMG_2123.jpeg",
      "/photos/2026/IMG_2524.jpeg",
      "/photos/2026/IMG_2560.jpeg",
      "/photos/2026/IMG_2568.jpeg",
      "/photos/2026/IMG_2571.jpeg",
      "/photos/2026/IMG_2572.jpeg",
      "/photos/2026/IMG_2596.jpeg",
      "/photos/2026/IMG_2597.jpeg",
      "/photos/2026/IMG_2599.jpeg",
      "/photos/2026/IMG_2602.jpeg",
      "/photos/2026/IMG_2604.jpeg",
      "/photos/2026/IMG_2607.jpeg",
      "/photos/2026/IMG_2618.jpeg",
      "/photos/2026/IMG_2634.jpeg",
      "/photos/2026/IMG_2637.jpeg",
      "/photos/2026/IMG_2642.jpeg",
      "/photos/2026/IMG_2643.jpeg",
      "/photos/2026/IMG_2645.jpeg",
      "/photos/2026/IMG_2647.jpeg",
      "/photos/2026/IMG_4219.jpeg",
      "/photos/2026/IMG_4252.jpeg",
      "/photos/2026/IMG_4269.jpeg",
      "/photos/2026/IMG_4287.jpeg",
      "/photos/2026/IMG_4305.jpeg",
      "/photos/2026/IMG_4313.jpeg",
      "/photos/2026/IMG_4334.jpeg",
      "/photos/2026/IMG_4347.jpeg",
      "/photos/2026/IMG_4355.jpeg",
      "/photos/2026/IMG_4387.jpeg",
      "/photos/2026/IMG_4403.jpeg",
      "/photos/2026/IMG_4414.jpeg",
      "/photos/2026/IMG_4416.jpeg",
      "/photos/2026/IMG_4429.jpeg",
      "/photos/2026/IMG_4440.jpeg",
      "/photos/2026/IMG_4441.jpeg",
      "/photos/2026/IMG_4442.jpeg",
      "/photos/2026/IMG_4448.jpeg",
      "/photos/2026/IMG_4785.jpeg",
      "/photos/2026/IMG_7192.jpeg",
      "/photos/2026/IMG_8530.jpeg",
      "/photos/2026/IMG_8533.jpeg",
      "/photos/2026/IMG_8537.jpeg",
      "/photos/2026/IMG_8547.jpeg",
      "/photos/2026/IMG_8576.jpeg",
      "/photos/2026/IMG_8579.jpeg",
      "/photos/2026/IMG_8583.jpeg",
      "/photos/2026/IMG_8826.jpeg",
      "/photos/2026/IMG_8829.jpeg",
      "/photos/2026/IMG_8858.jpeg",
      "/photos/2026/IMG_8910.jpeg",
      "/photos/2026/IMG_8940.jpeg",
      "/photos/2026/IMG_8961.jpeg",
      "/photos/2026/IMG_8972.jpeg",
      "/photos/2026/IMG_8997.jpeg",
      "/photos/2026/IMG_8998.jpeg",
    ],
  },
  {
    year: 2025,
