    ...
    schedule: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: "Easy first night. Beds go by the pre-trip athletic-feat draft — submissions due June 1, rulings final.",
            facts: ["Bed draft"],
          },
        ],
      },
      ...
      },
      {
        day: "Thursday",
        date: "July 8",
        subtitle: "Day 1, full group — the showstopper: Bay Harbor on the bluffs, then Crooked Tree above the bay. First dinner with everyone tonight — 🚌 35 min out, 5 min between",
        items: [
          {
            time: "8:00 AM",
            ...
            facts: ["27-hole facility", "Arthur Hills design", "Lake Michigan bluffs + quarry walls"],
          },
          {
            time: "1:45 PM",
          ...
          {
            time: "7:30 PM",
            activity: "First Dinner, Full Group",
            detail: "Everyone's in",
            type: "dining",
            location: "At the house",
            ...
            facts: ["Cash fines settled", "Mighty Fine Pizza, Petoskey — (231) 347-3255", "Stiggs BBQ carryout"],
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            facts: ["Hibachi Connect — (201) 565-3878", "Covers Boyne City / Harbor Springs / Emmet + Charlevoix", "10-guest minimum · one chef station up to 25", "Book 3–4 weeks out — July fills first"],
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            facts: ["Belt + trophy", "Superlatives", "Order before the Threetops bus leaves", "Stiggs BBQ — reheats best"],
          },
        ],
      },
      {
