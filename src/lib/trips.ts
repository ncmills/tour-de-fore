        ...
        items: [
          {
            ...
            location: "Kohler, WI",
            architect: "Pete Dye",
            description: "Pete Dye's rolling prairie masterpiece — wide fairways, oak savannahs, and glacier-carved terrain.",
          ...
          },
          {
            ...
            description: "Rolling terrain with friendly greens, a welcoming atmosphere, and a proper on-site restaurant to close the day.",
        ...
        items: [
          {
            ...
            description: "Dramatic elevation changes and strategic bunkering — every shot matters on this demanding Nicklaus layout.",
          ...
          },
          {
            ...
            type: "golf",
            location: "Kohler, WI",
            description: "A 10-hole par-3 built for fun, not scoring — 1-acre putting green, outdoor bar, and natural hot springs on-site.",
        ...
        items: [
          {
            ...
            type: "golf",
            location: "Valders, WI",
            description: "Wisconsin hidden gem — bent grass fairways, manicured greens, and a relaxed public atmosphere. Golf Digest 4-star.",
          ...
          },
          {
            ...
            description: "Authentic links-inspired Pete Dye design without the soul-crushing difficulty of the Straits — fescue, undulation, wind. Top 50 in the United States.",
        ...
        items: [
          {
            ...
            description: "A scenic Black Hills layout carved through pine-covered canyons and granite outcrops. Locals' favorite.",
        ...
        items: [
          {
            ...
            description: "Mountain resort course with stunning views of the Black Hills and challenging elevation changes — plays longer than the yardage.",
        ...
        items: [
          {
            ...
            type: "golf",
            location: "Spearfish, SD",
            description: "Hidden gem on the floor of Spearfish Canyon — creek crossings, dramatic limestone walls, and the coldest beer on the cart.",
        ...
        items: [
          {
            ...
            description: "Nicklaus Signature course set in the high desert with sweeping views of the Cascade Range and volcanic rock features.",
        ...
        items: [
          {
            ...
            type: "golf",
            location: "Redmond, OR",
            description: "Classic Pacific Northwest layout with mature juniper trees, lava outcrops, and uninterrupted Cascade mountain views.",
        ...
        items: [
          {
            ...
            description: "Playable resort course in the Deschutes National Forest — pine-lined fairways, creek crossings, and the locals' 'home' course.",
          ...
          },
          {
            ...
            description: "Links-style David McLay Kidd design with fescue rough and volcanic rock features — the closest thing to Scotland in Oregon.",
        ...
        items: [
          {
            ...
            description: "Well-maintained municipal with bluegrass-country charm, rolling terrain, and some of the best public greens in the state.",
        ...
        items: [
          {
            ...
            description: "Public course winding through mature hardwoods in the heart of horse country. Golfweek's #1 public course in Kentucky 7 years running.",
        ...
        items: [
          {
            ...
            type: "golf",
            location: "Lexington, KY",
            description: "Exclusive UK-affiliated course with immaculate conditions, manicured bunkers, and the prestige of Wildcat athletics stitched into the property.",
        ...
        items: [
          {
            ...
            type: "golf",
            location: "Kuna, ID",
            description: "Desert canyon course cut into the rolling foothills south of Boise — sagebrush, sand, and panoramic Treasure Valley views.",
        ...
        items: [
          {
            ...
            type: "golf",
            location: "Boise, ID",
            description: "Challenging layout in the Boise foothills with panoramic valley views, willow trees, and just enough water to make you think twice.",
        ...
        items: [
          {
            ...
            type: "golf",
            location: "Boise, ID",
            description: "Championship course known for dramatic elevation changes and Snake River views — blind tee shots and drops into canyons.",
        ...
        items: [
          {
            ...
            description: "Stunning desert links course carved through red sandstone with views of Snow Canyon — postcard scenery on every tee.",
        ...
        items: [
          {
            ...
            type: "golf",
            location: "St. George, UT",
            description: "Three distinct nines weaving through black lava fields and red rock in a spectacular setting — no two holes play alike.",
        ...
        items: [
          {
            ...
            type: "golf",
            location: "St. George, UT",
            description: "Dramatic desert course with red rock canyon walls rising behind every green and sweeping St. George valley views.",
