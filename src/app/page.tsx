  ...
  return (
    <>
      ...
      >
        ...
        <p>Plan the perfect group golf trip with AI. Tour de Fore covers 133 destinations across 7 regions in America with detailed course data, lodging options, dining recommendations, nightlife guides, and group activities. Whether you&apos;re planning a bachelor party golf trip, a budget-friendly golf weekend, or a bucket-list golf odyssey, our AI planner builds custom day-by-day itineraries for groups of 4 to 32.</p>
        ...
        <p>Featured regions: Southwest golf trips (Scottsdale, Sedona, Las Vegas), Southeast golf trips (Pinehurst, Kiawah Island, Myrtle Beach), Pacific Northwest golf trips (Bend, Bandon Dunes), Mountain West golf trips (Steamboat Springs, Park City), Midwest golf trips (Kohler, Traverse City), Northeast golf trips (Cape Cod, Pinehurst), and South Central golf trips (Austin, San Antonio).</p>
