    ...
    <footer className="border-t border-border mt-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          {/* Brand */}
          <div>
            <h3 className="font-display text-4xl font-semibold text-text mb-4">
              Tour de Fore
            </h3>
          ...
          {/* Trips */}
          <div>
            <h4 className="text-xs tracking-[0.2em] uppercase text-text-dim mb-6">
              Expeditions
            </h4>
            <div className="space-y-3">
              {trips.map((trip) => (
                ...
                >
                  <span className="font-display text-lg text-text group-hover:text-gold transition-colors">
                    {trip.year}
                  </span>
        ...
        <div className="rule-accent mt-16 mb-8" />
