    ...
    <footer className="border-t border-border/50 mt-0">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8">
          {/* Brand */}
          <div>
            <h3 className="font-display text-5xl font-semibold text-text mb-6">
              Tour de Fore
            </h3>
            <p className="text-text-muted text-sm leading-relaxed max-w-xs font-light">
              An annual pilgrimage to the fairways. Since 2021.
            </p>
          </div>

          {/* Trips */}
          <div>
            <h4 className="text-[10px] tracking-[0.4em] uppercase text-text-dim mb-8 font-body font-medium">
              Expeditions
            </h4>
            <div className="space-y-4">
              {trips.map((trip) => (
                ...
                >
                  <span className="font-display text-xl text-text group-hover:text-ember transition-colors duration-300">
                    {trip.year}
                  </span>
        ...
        <div className="rule-ember mt-20 mb-10" />
