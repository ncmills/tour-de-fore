...
export default function AttendeeForm({
  ...
  return (
    <div className="space-y-10">
      {/* Organizer */}
      <div>
        <div className="text-xs tracking-[0.15em] uppercase text-accent font-body font-medium mb-4">
          You (the organizer)
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <div className="text-xs tracking-[0.15em] uppercase text-accent font-body font-medium">
            Your Crew
          </div>
        ...
        <button
          ...
          className="mt-5 text-xs tracking-[0.15em] uppercase font-body text-accent hover:text-accent-hover transition-colors flex items-center gap-2"
        >
      ...
      {/* Counter */}
      <div className="bg-bg-alt border border-border rounded-lg p-6 flex items-center justify-between">
        <div className="font-body text-sm text-text-muted">
          Total attendees
        </div>
        <div className="flex items-center gap-3">
          <span className={`font-display text-3xl ${totalFilled >= 8 ? "text-green" : "text-accent"}`}>
            {totalFilled}
          </span>
